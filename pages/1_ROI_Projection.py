...
def main():
    ...
    land_premium   = res["residual_value"]     # Estimated land premium
    ...
    st.caption("ℹ️ Sales proceeds from flats are taken directly from Page 1 "
               "(Gross Development Value). Developer profit from Page 1 is the "
               "valuation margin and is therefore not re-charged as a cost here.")
